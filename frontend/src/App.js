...
import { faCaretDown, faCartArrowDown, faUser, faUserCog } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="grid-container">
        <header className="row">
          ...
          <div className="row">
            ...
            {userInfo && userInfo.isVendedor && <FontAwesomeIcon icon={faUserCog} />}
            <Link to="/cart">
        ...
        <main>
          ...
          <Routes>
            ...
            <Route path="/clientefastregister" element={<ClienteFastRegisterScreen />}></Route>
            <Route path="/payment" element={<PaymentMethodScreen />}></Route>
            <Route path="/placeorder" element={<PlaceOrderScreen />}></Route>
            <Route path="/placecotizacion" element={<PlaceCotizacionScreen />}></Route>
            <Route path="/order/:id" element={<OrderScreen />}></Route>
            <Route path="/printorder/:id" element={<PrintOrderScreen />} exact></Route>
            <Route path="/cotizacion/:id" element={<CotizacionScreen />}></Route>
            <Route path="/printcotizacion/:id" element={<PrintCotizacionScreen />} exact></Route>
