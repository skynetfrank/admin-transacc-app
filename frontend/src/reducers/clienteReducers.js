...
export const clienteRegisterReducer = (state = {}, action) => {
  switch (action.type) {
    case CLIENTE_REGISTER_REQUEST:
      return { loading: true };
    case CLIENTE_REGISTER_SUCCESS:
      return { loading: false, clienteInfo: action.payload };
...
export const clienteListReducer = (state = { loading: true }, action) => {
  switch (action.type) {
